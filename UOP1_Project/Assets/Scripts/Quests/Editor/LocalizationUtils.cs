...
public static class LocalizationUtils
{
    ...
    public static string GetLocalizedStringImmediateSafe(
        this LocalizedString localizedStringReference
    )
    {
        ...
        {
            var tableCollection = LocalizationEditorSettings.GetStringTableCollection(
                localizedStringReference.TableReference
            );
            ...
            if (locale != null)
            {
                ...
                if (table != null)
                    text = table
                        .GetEntryFromReference(localizedStringReference.TableEntryReference)
                        .LocalizedValue;
            }
        }
        return text;
